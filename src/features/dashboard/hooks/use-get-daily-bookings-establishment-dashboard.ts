...
import { getDailyBookingsEstablishmentService } from '../services/dashboard.services'

export function useGetDailyBookingsEstablishmentDashboard(
  ...
  return useQuery({
    queryKey: dashboardQueryKeys.dailyBookings(queryString),
    queryFn: () => getDailyBookingsEstablishmentService(queryString),
